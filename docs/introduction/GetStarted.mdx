...
* `yarn add @tecsinapse/react-core`: Contains components in common between web and native. It's not recommended to install this package, you should use specific platform.
* `yarn add @tecsinapse/react-native-kit`: Contains components specific to native applications.
