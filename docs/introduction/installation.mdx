...
This guide will have instructions for _cortex_ system, based on `tailwindcss`. If you need to setup `react-native-kit`, look for the setup menu on the left. For the new native stack, see [cortex-native](../setup/cortex-native.mdx).
