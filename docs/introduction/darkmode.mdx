...
`@tecsinapse/cortex-core` provides a dark mode feature, that works with the DarkThemeContext, providing functions and values to make your application as dinamic and beautiful as possible.
