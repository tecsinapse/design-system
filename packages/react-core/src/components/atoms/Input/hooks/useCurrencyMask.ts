...
interface CurrencyOptions extends currency.Options {}
 ...
 * @returns 
 */
export const useCurrencyMask = (options?: CurrencyOptions, defaultValue?: string): [Mask, (value: string) => void] => {

    const getRegex = useCallback((precision: number) => (
    ...
    const handleChangeValue = useCallback((formattedValue: string) => {
